  ...
  return (
    <SafeAreaView
      ...
      <PageHeader
        ...
        subtitle="How Top 3 handles your information."
      />
      ...
      <ScrollView
        ...
        <Paragraph>
          Top 3 is a social discovery app that lets people
          create and share ranked Top 3 lists, discover
          people with similar tastes, and interact with
          other members of the Top 3 community.
        </Paragraph>

        <Paragraph>
          This Privacy Policy explains what information
          Top 3 collects and processes, how that information
        ...
        <Paragraph>
          Top 3 is operated by Jeremy Linskill, based in
        ...
        <PolicySection title="1. Information We Collect and Process">
          ...
          <PolicySubsection title="Account and Authentication Information">
            ...
            <Paragraph>
              ...
              authenticate your Top 3 account through
              Supabase.
            </Paragraph>

            <Paragraph>
              Top 3 does not receive your Apple ID password,
          ...
          <PolicySubsection title="Profile Information">
            <Paragraph>
              You may provide information for your Top 3
              profile, including:
            </Paragraph>
            ...
            <Paragraph>
              ...
              visible to other people as part of Top 3&apos;s
          ...
          <PolicySubsection title="Profile Images and Photo-Library Access">
            <Paragraph>
              ...
              Top 3 requests permission to access your
              device&apos;s photo library so that you can
              select an image.
            </Paragraph>

            <Paragraph>
              Top 3 accesses the photo library when you choose
              to use a feature that requires selecting an
              image. The selected profile image is uploaded
              and stored using Top 3&apos;s cloud
              infrastructure.
            </Paragraph>

            <Paragraph>
              Top 3 does not currently request camera
              permission.
            </Paragraph>
          </PolicySubsection>
          ...
          <PolicySubsection title="Lists and Other Content You Create">
            <Paragraph>
              Top 3 stores information you create or publish
            ...
            <Paragraph>
              ...
              account visibility and Top 3&apos;s access
              controls.
            </Paragraph>
          </PolicySubsection>
          ...
          <PolicySubsection title="Social Activity">
            <Paragraph>
              Top 3 stores information about interactions
            ...
            <Paragraph>
              We use this information to provide Top 3&apos;s
          ...
          <PolicySubsection title="Push Notifications">
            <Paragraph>
              If you choose to enable push notifications, Top 3
              receives and stores a push notification token
              associated with your device and Top 3 account. This
            ...
            <Paragraph>
              Top 3 uses Apple Push Notification service and
            ...
            <Paragraph>
              You can turn Top 3 push notifications on or off
              through Top 3&apos;s notification settings. You can
          ...
          <PolicySubsection title="Reports and Moderation Information">
            <Paragraph>
              ...
              supported content, Top 3 may collect:
            </Paragraph>
            ...
            <Paragraph>
              ...
              enforce Top 3&apos;s rules, protect users,
          ...
          <PolicySubsection title="Search Information">
            ...
            <Paragraph>
              Depending on the type of content, Top 3
            ...
            <Paragraph>
              ...
              Top 3&apos;s backend infrastructure rather than
            ...
            <Paragraph>
              ...
              through Top 3&apos;s backend services.
            </Paragraph>

            <Paragraph>
              Top 3 also maintains a limited list of up to 10
              ...
              device and associated locally with your Top 3
              account rather than stored as part of your
              server-side Top 3 profile.
            </Paragraph>
          </PolicySubsection>

          <PolicySubsection title="Media Previews and Trailers">
            <Paragraph>
              Top 3 may allow you to play media associated
          ...
          <PolicySubsection title="Usage and Analytics Information">
            <Paragraph>
              Top 3 uses product analytics to understand how
            ...
            <Paragraph>
              ...
              be associated with your Top 3 user identifier so
              that we can understand how the service is being
              used.
            </Paragraph>

            <Paragraph>
              Top 3 currently uses Amplitude to provide
              product analytics.
            </Paragraph>
            ...
            <Paragraph>
              ...
              you are signed in, Top 3 also associates analytics
              activity with your Top 3 user identifier.
            </Paragraph>

            <Paragraph>
              Top 3 configures the Amplitude SDK not to
            ...
            <Paragraph>
              Top 3 uses Amplitude for product analytics
          ...
          <PolicySubsection title="Device and Local Application Information">
            <Paragraph>
              Top 3 stores certain information locally on your
        ...
        <PolicySection title="2. Information We Do Not Intentionally Collect">
          <Paragraph>
            Based on the features currently offered in Top 3,
            Top 3 does not intentionally collect:
          </Paragraph>
          ...
          <Paragraph>
            Top 3 does not currently display third-party
            advertising.
          </Paragraph>
          ...
          <Paragraph>
            Top 3 does not use your personal information to
        ...
        <PolicySection title="3. How We Use Information">
          ...
          <Paragraph>
            We do not use information collected through Top 3
        ...
        <PolicySection title="4. Public and Private Information">
          <Paragraph>
            Top 3 is a social service. Some information you
          ...
          <Paragraph>
            ...
            requiring them to sign in, where Top 3 supports
            signed-out viewing.
          </Paragraph>
          ...
          <Paragraph>
            ...
            Top 3&apos;s private-account and approved-follower
            rules.
          </Paragraph>
          ...
          <Paragraph>
            ...
            according to Top 3&apos;s blocking features.
          </Paragraph>
        ...
        <PolicySection title="5. How We Share Information">
          ...
          <Paragraph>
            ...
            operate Top 3, provide features you request,
          ...
          <PolicySubsection title="Infrastructure and Service Providers">
            <Paragraph>
              Top 3 relies on third-party service providers
            ...
            <Paragraph>
              ...
              used by Top 3, and for delivery of push
            ...
            <Paragraph>
              ...
              necessary to perform the services Top 3 uses.
            </Paragraph>

            <Paragraph>
              Third-party service providers that process
              personal information on Top 3&apos;s behalf are
          ...
          <PolicySubsection title="Content, Search, and Media Providers">
            <Paragraph>
              Top 3 uses third-party services to retrieve
            ...
            <Paragraph>
              Top 3 does not intentionally provide these
              content providers with your Top 3 password or
              your complete Top 3 social profile merely to
          ...
          <PolicySubsection title="Other Users and People Viewing Shared Content">
            <Paragraph>
              ...
              Top 3 may be visible to other users according to
          ...
          <PolicySubsection title="Legal, Safety, and Security Reasons">
            ...
            <BulletList
              items={[
                ...
                'Protect the rights or property of Top 3 or others.',
          ...
          <PolicySubsection title="Business Changes">
            <Paragraph>
              If Top 3 is transferred to a company or other
        ...
        <PolicySection title="6. Analytics">
          <Paragraph>
            Top 3 uses Amplitude to understand how users
          ...
          <Paragraph>
            Top 3&apos;s analytics implementation is intended
            for product analytics rather than advertising.
          </Paragraph>

          <Paragraph>
            Top 3 does not use Amplitude to serve third-party
          ...
          <Paragraph>
            When you delete your Top 3 account, Top 3 submits a
            request to Amplitude to delete analytics
            information associated with your Top 3 user
            identifier.
          </Paragraph>
        ...
        <PolicySection title="7. Data Retention">
          <Paragraph>
            Top 3 generally retains account-associated
          ...
          <Paragraph>
            ...
            Top 3 account may be removed when you disable Top 3
            push notifications and are removed as part of the
            applicable account-deletion process.
          </Paragraph>

          <Paragraph>
            When you delete content or your account, Top 3
          ...
          <Paragraph>
            ...
            it is no longer publicly visible through Top 3.
          </Paragraph>
          ...
          <Paragraph>
            Top 3 does not intentionally retain personal
        ...
        <PolicySection title="8. Account and Data Deletion">
          <Paragraph>
            You can permanently delete your Top 3 account
          ...
          <Paragraph>Where applicable, Top 3 also:</Paragraph>

          <BulletList
            items={[
              'Removes your stored profile image.',
              'Removes push notification tokens associated with the deleted Top 3 account.',
              'Submits a request to Amplitude to delete analytics information associated with your Top 3 user identifier.',
              'Revokes associated Sign in with Apple authorization for Apple-authenticated accounts.',
            ]}
          />

          <Paragraph>
            When account deletion succeeds, Top 3 also clears
            the recent-search history stored locally for that
            Top 3 account on the device used to perform the
            deletion.
          </Paragraph>
        ...
        <PolicySection title="9. Your Privacy Choices and Rights">
          ...
          <Paragraph>
            ...
            within Top 3, including profile information,
        ...
        <PolicySection title="10. Security">
          <Paragraph>
            Top 3 uses technical safeguards intended to help
          ...
          <Paragraph>
            Access to Top 3 data and functionality is
        ...
        <PolicySection title="11. International Processing">
          ...
          <Paragraph>
            Some third-party services used to operate Top 3
        ...
        <PolicySection title="12. Children and Teen Users">
          <Paragraph>
            Top 3 is intended for users who are 13 years of
            age or older.
          </Paragraph>
          ...
          <Paragraph>
            Top 3 is not designed or directed specifically to
          ...
          <Paragraph>
            ...
            Top 3, we may take steps to remove the account and
        ...
        <PolicySection title="13. Third-Party Services and Content">
          <Paragraph>
            Top 3 uses and interacts with third-party services
          ...
          <Paragraph>
            Top 3 does not control the independent privacy
            practices of third-party services except to the
            extent a provider processes information on
            Top 3&apos;s behalf under its service relationship
            with Top 3.
          </Paragraph>
        ...
        <PolicySection title="14. Changes to This Privacy Policy">
          <Paragraph>
            We may update this Privacy Policy as Top 3
          ...
          <Paragraph>
            ...
            Top 3 will provide additional notice or obtain
