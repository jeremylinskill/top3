...
function createMusicTopics(
  ...
  return MUSIC_GENRES.map((genre) => ({
    ...
    name: genre.name,
    icon: genre.icon,
    searchItemName: `${genre.name.toLowerCase()} ${itemName}`,
  }));
}
...
export const TOP3_CATEGORIES: Top3Category[] = [
  {
    ...
    topics: [
      ...createMusicTopics('album'),
      {
        id: 'soundtrack',
        name: 'Soundtrack',
        icon: '🎞️',
        searchItemName: 'soundtrack album',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'romance', name: 'Romance', icon: '❤️', searchItemName: 'romance book' },
      { id: 'sci-fi', name: 'Sci-Fi', icon: '🛸', searchItemName: 'science fiction book' },
      { id: 'self-help', name: 'Self-Help', icon: '🌱', searchItemName: 'self-help book' },
    ],
  },
  {
    id: 'movies',
  ...
  },
  {
    ...
    topics: [
      ...
      { id: 'drama', name: 'Drama', icon: '🎭', searchItemName: 'drama TV show', tmdbGenreId: 18 },
      { id: 'fantasy', name: 'Fantasy', icon: '🐉', searchItemName: 'fantasy TV show', tmdbGenreId: 10765 },
      { id: 'reality', name: 'Reality', icon: '🌟', searchItemName: 'reality TV show', tmdbGenreId: 10764 },
      { id: 'sci-fi', name: 'Sci-Fi', icon: '🚀', searchItemName: 'science fiction TV show', tmdbGenreId: 10765 },
      { id: 'animated', name: 'Animated', icon: '🖍️', searchItemName: 'animated TV show', tmdbGenreId: 16 },
    ],
  },
  {
    id: 'games',
    ...
    topics: [
      ...
      { id: 'shooter', name: 'Shooter', icon: '🔫', searchItemName: 'shooter game' },
      { id: 'strategy', name: 'Strategy', icon: '♟️', searchItemName: 'strategy game' },
      { id: 'simulation', name: 'Simulation', icon: '🏗️', searchItemName: 'simulation game' },
      { id: 'racing', name: 'Racing', icon: '🏎️', searchItemName: 'racing game' },
      { id: 'sports', name: 'Sports', icon: '⚽', searchItemName: 'sports game' },
      { id: 'puzzle', name: 'Puzzle', icon: '🧩', searchItemName: 'puzzle game' },
    ],
  },
];